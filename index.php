...
<head>
    ...
    <link rel="icon" href="img/icon.png" type="jpg/png/jpeg">
</head>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-block bg-primary shadow-lg p-5 text-center">
                                <img src="img/icon.png" alt="" width="400" height="400">
                                <h3 class="text-white">Sistem Informasi Tamu 
                                <br>PT.PELINDO <small>
                                    <br>
                                    Reg.1 Tanjungpinang
                                </h3>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a href="http://instagram.com/" target="_blank">By &copy; Cahyadi Prasetyo</a>
                                    </div>
                                </div>
                            </div>
                        </div>
